module m_Parameters
  ...
  real(RK),public,save:: PrGradAverOld=zero
#endif
...
#if defined CFDDEM || defined CFDACM
    NAMELIST/CouplingMeshParam/yBed
#endif
...
#if defined CFDDEM || defined CFDACM
    read(nUnitFile, nml=CouplingMeshParam)
#endif
    close(nUnitFile)  
...
#if defined CFDDEM || defined CFDACM
    write(d_LogInfo_unit, nml=CouplingMeshParam)
#endif
...
#if defined CFDDEM || defined CFDACM
    if(ns==1) then 
      PrGradAverOld=PrGradAver; PrGradAver=zero
    endif
#else
